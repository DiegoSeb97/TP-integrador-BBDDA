...
BEGIN
	UPDATE SUCURSAL.sucursal SET BAJA = 'SI' WHERE ID = @ID
END
GO
...
BEGIN
	UPDATE SUCURSAL.SUCURSAL SET BAJA = 'NO' WHERE ID = @ID
END
GO
...
BEGIN
	UPDATE SUCURSAL.EMPLEADO SET BAJA = 'SI' WHERE legajoId = @LEGAJO
END
GO
...
BEGIN
	UPDATE SUCURSAL.EMPLEADO SET BAJA = 'NO' WHERE LEGAJOID = @LEGAJO
END
GO
...
AS 
BEGIN
	UPDATE VENTASSUCURSAL.VENTA_REGISTRADA SET VALIDA = 'NO' WHERE ID_FACTURA = @ID
END
GO
...
AS 
BEGIN
	UPDATE VENTASSUCURSAL.VENTA_REGISTRADA SET VALIDA = 'SI' WHERE ID_FACTURA = @ID
END
...
--INSERTAR FACTURA
CREATE OR ALTER PROCEDURE VENTASSUCURSAL.CREAR_FACTURA(@fecha date, @estado varchar(20))
AS
BEGIN
	INSERT INTO ventasSucursal.factura(fecha, estado)
	VALUES(@fecha, @estado);
END
