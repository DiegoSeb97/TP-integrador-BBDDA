...
GO
--INSERTAR VENTA
CREATE OR ALTER PROCEDURE VENTASSUCURSAL.REGISTRAR_VENTA (@TIPO_FACT CHAR, @CIUDAD VARCHAR(20), @TIPO_CLIENTE VARCHAR(10), @GENERO VARCHAR(10), @PROD VARCHAR(100), @PRECIO NUMERIC(10,2), @CANTIDAD INT, 
														  @FECHA DATE, @HORA TIME, @MEDIO_PAGO VARCHAR(20), @EMPLEADO_ID INT, @IDENTIFICADOR_PAGO VARCHAR(50)) AS
INSERT INTO ventasSucursal.venta_registrada(tipo_de_factura, CIUDAD, tipo_de_cliente, GENERO, producto, precio_unitario, CANTIDAD, FECHA, HORA, medio_de_pago, empleado_id, identificador_de_pago)
VALUES (@TIPO_FACT, @CIUDAD, @TIPO_CLIENTE, @GENERO, @PROD, @PRECIO, @CANTIDAD, @FECHA, @HORA, @MEDIO_PAGO, @EMPLEADO_ID, @IDENTIFICADOR_PAGO)
go
